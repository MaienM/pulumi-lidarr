 ...
 *
 * const example = new lidarr.notifications.Notification("example", {
...
export class Notification extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Notifications/notification:Notification';
    ...
    constructor(name: string, argsOrState?: NotificationArgs | NotificationState, opts?: pulumi.CustomResourceOptions) {
        ...
        const secretOpts = { additionalSecretOutputs: ["authPassword", "configurationKey", "key", "senderNumber"] };
