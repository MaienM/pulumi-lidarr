 ...
 *
 * const example = new lidarr.notifications.NotificationBoxcar("example", {
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Notifications/notificationBoxcar:NotificationBoxcar example 1
 * ```
 */
export class NotificationBoxcar extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Notifications/notificationBoxcar:NotificationBoxcar';
