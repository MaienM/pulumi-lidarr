 ...
 *
 * const example = new lidarr.importlists.ImportListSpotifyAlbums("example", {
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:ImportLists/importListSpotifyAlbums:ImportListSpotifyAlbums example 1
 * ```
 */
export class ImportListSpotifyAlbums extends pulumi.CustomResource {
    /**
     * Get an existing ImportListSpotifyAlbums resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ImportListSpotifyAlbumsState, opts?: pulumi.CustomResourceOptions): ImportListSpotifyAlbums {
        return new ImportListSpotifyAlbums(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'lidarr:ImportLists/importListSpotifyAlbums:ImportListSpotifyAlbums';

    /**
     * Returns true if the given object is an instance of ImportListSpotifyAlbums.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ImportListSpotifyAlbums {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ImportListSpotifyAlbums.__pulumiType;
    }
    ...
    /**
     * Create a ImportListSpotifyAlbums resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ImportListSpotifyAlbumsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ImportListSpotifyAlbumsArgs | ImportListSpotifyAlbumsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ImportListSpotifyAlbumsState | undefined;
            ...
            const args = argsOrState as ImportListSpotifyAlbumsArgs | undefined;
        ...
        super(ImportListSpotifyAlbums.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering ImportListSpotifyAlbums resources.
 */
export interface ImportListSpotifyAlbumsState {
    /**
     * Access token.
     */
...
/**
 * The set of arguments for constructing a ImportListSpotifyAlbums resource.
 */
export interface ImportListSpotifyAlbumsArgs {
    /**
     * Access token.
     */
    accessToken: pulumi.Input<string>;
