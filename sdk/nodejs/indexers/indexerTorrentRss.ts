 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Indexers/indexerTorrentRss:IndexerTorrentRss example 1
 * ```
 */
export class IndexerTorrentRss extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Indexers/indexerTorrentRss:IndexerTorrentRss';
