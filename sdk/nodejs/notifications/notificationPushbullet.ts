 ...
 *
 * const example = new lidarr.notifications.NotificationPushbullet("example", {
 *     apiKey: "Token",
 *     deviceIds: ["test"],
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Notifications/notificationPushbullet:NotificationPushbullet example 1
 * ```
 */
export class NotificationPushbullet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Notifications/notificationPushbullet:NotificationPushbullet';
