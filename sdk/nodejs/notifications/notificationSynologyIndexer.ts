 ...
 *
 * const example = new lidarr.notifications.NotificationSynologyIndexer("example", {
 *     name: "Example",
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Notifications/notificationSynologyIndexer:NotificationSynologyIndexer example 1
 * ```
 */
export class NotificationSynologyIndexer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Notifications/notificationSynologyIndexer:NotificationSynologyIndexer';
