 ...
 *
 * const example = new lidarr.indexers.IndexerIptorrents("example", {
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Indexers/indexerIptorrents:IndexerIptorrents example 1
 * ```
 */
export class IndexerIptorrents extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Indexers/indexerIptorrents:IndexerIptorrents';
