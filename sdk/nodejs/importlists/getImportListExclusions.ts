 ...
 *
 * const example = lidarr.ImportLists.getImportListExclusions({});
 * ```
 */
export function getImportListExclusions(opts?: pulumi.InvokeOptions): Promise<GetImportListExclusionsResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("lidarr:ImportLists/getImportListExclusions:getImportListExclusions", {
    }, opts);
}
