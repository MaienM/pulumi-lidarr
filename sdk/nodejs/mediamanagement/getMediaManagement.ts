 ...
 *
 * const example = lidarr.MediaManagement.getMediaManagement({});
 * ```
 */
export function getMediaManagement(opts?: pulumi.InvokeOptions): Promise<GetMediaManagementResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("lidarr:MediaManagement/getMediaManagement:getMediaManagement", {
    }, opts);
}
...
export interface GetMediaManagementResult {
     ...
     */
    readonly unmonitorPreviousTracks: boolean;
    /**
     * Whatch library for changes.
     */
    readonly watchLibraryForChanges: boolean;
}
