 ...
 *
 * const example = new lidarr.notifications.NotificationTwitter("example", {
 *     accessToken: "Token",
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Notifications/notificationTwitter:NotificationTwitter example 1
 * ```
 */
export class NotificationTwitter extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Notifications/notificationTwitter:NotificationTwitter';
