 ...
 *
 * const example = lidarr.Notifications.getNotification({
 *     name: "Example",
 * });
 * ```
 */
export function getNotification(args: GetNotificationArgs, opts?: pulumi.InvokeOptions): Promise<GetNotificationResult> {
    ...
    return pulumi.runtime.invoke("lidarr:Notifications/getNotification:getNotification", {
        "name": args.name,
    }, opts);
}
...
export interface GetNotificationResult {
     ...
     */
    readonly onAlbumDelete: boolean;
    /**
     ...
     */
    readonly onArtistDelete: boolean;
    /**
