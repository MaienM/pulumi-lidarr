 ...
 *
 * const example = new lidarr.indexers.IndexerNyaa("example", {
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Indexers/indexerNyaa:IndexerNyaa example 1
 * ```
 */
export class IndexerNyaa extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Indexers/indexerNyaa:IndexerNyaa';
