 ...
 *
 * const example = new lidarr.notifications.NotificationKodi("example", {
 *     host: "http://kodi.com",
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Notifications/notificationKodi:NotificationKodi example 1
 * ```
 */
export class NotificationKodi extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Notifications/notificationKodi:NotificationKodi';
