 ...
 *
 * const example = new lidarr.downloadclients.DownloadClientTorrentBlackhole("example", {
 *     enable: true,
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:DownloadClients/downloadClientTorrentBlackhole:DownloadClientTorrentBlackhole example 1
 * ```
 */
export class DownloadClientTorrentBlackhole extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:DownloadClients/downloadClientTorrentBlackhole:DownloadClientTorrentBlackhole';
