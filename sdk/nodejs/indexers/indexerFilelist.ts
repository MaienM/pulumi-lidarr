 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Indexers/indexerFilelist:IndexerFilelist example 1
 * ```
 */
export class IndexerFilelist extends pulumi.CustomResource {
    /**
     * Get an existing IndexerFilelist resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IndexerFilelistState, opts?: pulumi.CustomResourceOptions): IndexerFilelist {
        return new IndexerFilelist(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'lidarr:Indexers/indexerFilelist:IndexerFilelist';

    /**
     * Returns true if the given object is an instance of IndexerFilelist.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IndexerFilelist {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IndexerFilelist.__pulumiType;
    }
    ...
    /**
     * Create a IndexerFilelist resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IndexerFilelistArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IndexerFilelistArgs | IndexerFilelistState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IndexerFilelistState | undefined;
            ...
            const args = argsOrState as IndexerFilelistArgs | undefined;
            if ((!args || args.name === undefined) && !opts.urn) {
                throw new Error("Missing required property 'name'");
            }
            if ((!args || args.passkey === undefined) && !opts.urn) {
                throw new Error("Missing required property 'passkey'");
            }
        ...
        super(IndexerFilelist.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering IndexerFilelist resources.
 */
export interface IndexerFilelistState {
    /**
     * Base URL.
     */
...
/**
 * The set of arguments for constructing a IndexerFilelist resource.
 */
export interface IndexerFilelistArgs {
    /**
     * Base URL.
     */
    baseUrl?: pulumi.Input<string>;
