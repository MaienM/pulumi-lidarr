...
export { IndexerHeadphonesArgs, IndexerHeadphonesState } from "./indexerHeadphones";
export type IndexerHeadphones = import("./indexerHeadphones").IndexerHeadphones;
export const IndexerHeadphones: typeof import("./indexerHeadphones").IndexerHeadphones = null as any;
utilities.lazyLoad(exports, ["IndexerHeadphones"], () => require("./indexerHeadphones"));
...
export { IndexerRedactedArgs, IndexerRedactedState } from "./indexerRedacted";
export type IndexerRedacted = import("./indexerRedacted").IndexerRedacted;
export const IndexerRedacted: typeof import("./indexerRedacted").IndexerRedacted = null as any;
utilities.lazyLoad(exports, ["IndexerRedacted"], () => require("./indexerRedacted"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "lidarr:Indexers/indexer:Indexer":
                return new Indexer(name, <any>undefined, { urn })
            case "lidarr:Indexers/indexerConfig:IndexerConfig":
                return new IndexerConfig(name, <any>undefined, { urn })
            case "lidarr:Indexers/indexerFilelist:IndexerFilelist":
                return new IndexerFilelist(name, <any>undefined, { urn })
            case "lidarr:Indexers/indexerGazelle:IndexerGazelle":
                return new IndexerGazelle(name, <any>undefined, { urn })
            case "lidarr:Indexers/indexerHeadphones:IndexerHeadphones":
                return new IndexerHeadphones(name, <any>undefined, { urn })
            case "lidarr:Indexers/indexerIptorrents:IndexerIptorrents":
                return new IndexerIptorrents(name, <any>undefined, { urn })
            case "lidarr:Indexers/indexerNewznab:IndexerNewznab":
                return new IndexerNewznab(name, <any>undefined, { urn })
            case "lidarr:Indexers/indexerNyaa:IndexerNyaa":
                return new IndexerNyaa(name, <any>undefined, { urn })
            case "lidarr:Indexers/indexerRarbg:IndexerRarbg":
                return new IndexerRarbg(name, <any>undefined, { urn })
            case "lidarr:Indexers/indexerRedacted:IndexerRedacted":
                return new IndexerRedacted(name, <any>undefined, { urn })
            case "lidarr:Indexers/indexerTorrentRss:IndexerTorrentRss":
                return new IndexerTorrentRss(name, <any>undefined, { urn })
            case "lidarr:Indexers/indexerTorrentleech:IndexerTorrentleech":
                return new IndexerTorrentleech(name, <any>undefined, { urn })
            case "lidarr:Indexers/indexerTorznab:IndexerTorznab":
...
pulumi.runtime.registerResourceModule("lidarr", "Indexers/indexer", _module)
pulumi.runtime.registerResourceModule("lidarr", "Indexers/indexerConfig", _module)
pulumi.runtime.registerResourceModule("lidarr", "Indexers/indexerFilelist", _module)
pulumi.runtime.registerResourceModule("lidarr", "Indexers/indexerGazelle", _module)
pulumi.runtime.registerResourceModule("lidarr", "Indexers/indexerHeadphones", _module)
pulumi.runtime.registerResourceModule("lidarr", "Indexers/indexerIptorrents", _module)
pulumi.runtime.registerResourceModule("lidarr", "Indexers/indexerNewznab", _module)
pulumi.runtime.registerResourceModule("lidarr", "Indexers/indexerNyaa", _module)
pulumi.runtime.registerResourceModule("lidarr", "Indexers/indexerRarbg", _module)
pulumi.runtime.registerResourceModule("lidarr", "Indexers/indexerRedacted", _module)
pulumi.runtime.registerResourceModule("lidarr", "Indexers/indexerTorrentRss", _module)
pulumi.runtime.registerResourceModule("lidarr", "Indexers/indexerTorrentleech", _module)
pulumi.runtime.registerResourceModule("lidarr", "Indexers/indexerTorznab", _module)
