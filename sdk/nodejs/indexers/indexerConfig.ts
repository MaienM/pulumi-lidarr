 ...
 *
 * const example = new lidarr.indexers.IndexerConfig("example", {
 *     maximumSize: 0,
 *     minimumAge: 0,
 *     retention: 0,
 *     rssSyncInterval: 25,
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Indexers/indexerConfig:IndexerConfig example
 * ```
 */
export class IndexerConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Indexers/indexerConfig:IndexerConfig';
