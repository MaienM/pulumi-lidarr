 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Indexers/indexerRedacted:IndexerRedacted example 1
 * ```
 */
export class IndexerRedacted extends pulumi.CustomResource {
    /**
     * Get an existing IndexerRedacted resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IndexerRedactedState, opts?: pulumi.CustomResourceOptions): IndexerRedacted {
        return new IndexerRedacted(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'lidarr:Indexers/indexerRedacted:IndexerRedacted';

    /**
     * Returns true if the given object is an instance of IndexerRedacted.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IndexerRedacted {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IndexerRedacted.__pulumiType;
    }
     ...
     */
    public readonly discographySeedTime!: pulumi.Output<number>;
    /**
     * Early release limit.
     */
     ...
     */
    public readonly useFreeleechToken!: pulumi.Output<boolean>;

    /**
     * Create a IndexerRedacted resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IndexerRedactedArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IndexerRedactedArgs | IndexerRedactedState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IndexerRedactedState | undefined;
            resourceInputs["apiKey"] = state ? state.apiKey : undefined;
            resourceInputs["discographySeedTime"] = state ? state.discographySeedTime : undefined;
            ...
            resourceInputs["useFreeleechToken"] = state ? state.useFreeleechToken : undefined;
        } else {
            const args = argsOrState as IndexerRedactedArgs | undefined;
            ...
            resourceInputs["discographySeedTime"] = args ? args.discographySeedTime : undefined;
            ...
            resourceInputs["useFreeleechToken"] = args ? args.useFreeleechToken : undefined;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        const secretOpts = { additionalSecretOutputs: ["apiKey"] };
        opts = pulumi.mergeOptions(opts, secretOpts);
        super(IndexerRedacted.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering IndexerRedacted resources.
 */
export interface IndexerRedactedState {
    /**
     * API key.
     */
     ...
     * Discography seed time.
     */
    discographySeedTime?: pulumi.Input<number>;
    /**
     * Early release limit.
     */
     ...
     * Use freeleech token flag.
     */
    useFreeleechToken?: pulumi.Input<boolean>;
}

/**
 * The set of arguments for constructing a IndexerRedacted resource.
 */
export interface IndexerRedactedArgs {
    /**
     * API key.
     */
    apiKey: pulumi.Input<string>;
