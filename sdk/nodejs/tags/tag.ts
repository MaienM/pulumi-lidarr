 ...
 *
 * const example = new lidarr.tags.Tag("example", {label: "some-value"});
 * ```
 *
 * ## Import
 *
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Tags/tag:Tag example 10
 * ```
 */
export class Tag extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Tags/tag:Tag';
