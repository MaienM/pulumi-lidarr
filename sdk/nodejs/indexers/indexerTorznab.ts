 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Indexers/indexerTorznab:IndexerTorznab example 1
 * ```
 */
export class IndexerTorznab extends pulumi.CustomResource {
    /**
     * Get an existing IndexerTorznab resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IndexerTorznabState, opts?: pulumi.CustomResourceOptions): IndexerTorznab {
        return new IndexerTorznab(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'lidarr:Indexers/indexerTorznab:IndexerTorznab';

    /**
     * Returns true if the given object is an instance of IndexerTorznab.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IndexerTorznab {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IndexerTorznab.__pulumiType;
    }
    ...
    /**
     * Create a IndexerTorznab resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IndexerTorznabArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IndexerTorznabArgs | IndexerTorznabState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IndexerTorznabState | undefined;
            ...
            const args = argsOrState as IndexerTorznabArgs | undefined;
        ...
        super(IndexerTorznab.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering IndexerTorznab resources.
 */
export interface IndexerTorznabState {
    /**
     * Additional parameters.
     */
...
/**
 * The set of arguments for constructing a IndexerTorznab resource.
 */
export interface IndexerTorznabArgs {
    /**
     * Additional parameters.
     */
    additionalParameters?: pulumi.Input<string>;
