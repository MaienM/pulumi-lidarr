 ...
 *
 * const example = new lidarr.notifications.NotificationJoin("example", {
 *     apiKey: "Key",
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Notifications/notificationJoin:NotificationJoin example 1
 * ```
 */
export class NotificationJoin extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Notifications/notificationJoin:NotificationJoin';
