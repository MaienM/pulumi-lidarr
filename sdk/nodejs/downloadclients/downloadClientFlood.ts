 ...
 *
 * const example = new lidarr.downloadclients.DownloadClientFlood("example", {
 *     addPaused: true,
 *     additionalTags: [
 *         0,
 *         1,
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:DownloadClients/downloadClientFlood:DownloadClientFlood example 1
 * ```
 */
export class DownloadClientFlood extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:DownloadClients/downloadClientFlood:DownloadClientFlood';
