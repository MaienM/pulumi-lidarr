 ...
 *
 * const example = new lidarr.downloadclient.DownloadClientPneumatic("example", {
 *     enable: true,
 *     name: "Example",
 *     nzbFolder: "/nzb/",
 *     priority: 1,
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:DownloadClient/downloadClientPneumatic:DownloadClientPneumatic example 1
 * ```
 */
export class DownloadClientPneumatic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:DownloadClient/downloadClientPneumatic:DownloadClientPneumatic';
