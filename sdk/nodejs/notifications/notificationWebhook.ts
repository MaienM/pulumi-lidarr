 ...
 *
 * const example = new lidarr.notifications.NotificationWebhook("example", {
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Notifications/notificationWebhook:NotificationWebhook example 1
 * ```
 */
export class NotificationWebhook extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Notifications/notificationWebhook:NotificationWebhook';
