 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Indexers/indexerGazelle:IndexerGazelle example 1
 * ```
 */
export class IndexerGazelle extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Indexers/indexerGazelle:IndexerGazelle';
