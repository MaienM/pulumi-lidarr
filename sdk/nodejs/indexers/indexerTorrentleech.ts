 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Indexers/indexerTorrentleech:IndexerTorrentleech example 1
 * ```
 */
export class IndexerTorrentleech extends pulumi.CustomResource {
    /**
     * Get an existing IndexerTorrentleech resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IndexerTorrentleechState, opts?: pulumi.CustomResourceOptions): IndexerTorrentleech {
        return new IndexerTorrentleech(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'lidarr:Indexers/indexerTorrentleech:IndexerTorrentleech';

    /**
     * Returns true if the given object is an instance of IndexerTorrentleech.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IndexerTorrentleech {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IndexerTorrentleech.__pulumiType;
    }
    ...
    /**
     * Create a IndexerTorrentleech resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IndexerTorrentleechArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: IndexerTorrentleechArgs | IndexerTorrentleechState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IndexerTorrentleechState | undefined;
            ...
            const args = argsOrState as IndexerTorrentleechArgs | undefined;
        ...
        super(IndexerTorrentleech.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering IndexerTorrentleech resources.
 */
export interface IndexerTorrentleechState {
    /**
     * API key.
     */
...
/**
 * The set of arguments for constructing a IndexerTorrentleech resource.
 */
export interface IndexerTorrentleechArgs {
    /**
     * API key.
     */
    apiKey: pulumi.Input<string>;
