...
export class MediaManagement extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:MediaManagement/mediaManagement:MediaManagement';
     ...
     */
    public readonly unmonitorPreviousTracks!: pulumi.Output<boolean>;
    /**
     * Whatch library for changes.
     */
    public readonly watchLibraryForChanges!: pulumi.Output<boolean>;
    ...
    constructor(name: string, argsOrState?: MediaManagementArgs | MediaManagementState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["unmonitorPreviousTracks"] = state ? state.unmonitorPreviousTracks : undefined;
            resourceInputs["watchLibraryForChanges"] = state ? state.watchLibraryForChanges : undefined;
        } else {
            ...
            if ((!args || args.unmonitorPreviousTracks === undefined) && !opts.urn) {
                throw new Error("Missing required property 'unmonitorPreviousTracks'");
            }
            if ((!args || args.watchLibraryForChanges === undefined) && !opts.urn) {
                throw new Error("Missing required property 'watchLibraryForChanges'");
            }
            ...
            resourceInputs["unmonitorPreviousTracks"] = args ? args.unmonitorPreviousTracks : undefined;
            resourceInputs["watchLibraryForChanges"] = args ? args.watchLibraryForChanges : undefined;
        }
