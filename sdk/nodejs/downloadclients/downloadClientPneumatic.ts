 ...
 *
 * const example = new lidarr.downloadclients.DownloadClientPneumatic("example", {
 *     enable: true,
 *     name: "Example",
 *     nzbFolder: "/nzb/",
 *     priority: 1,
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:DownloadClients/downloadClientPneumatic:DownloadClientPneumatic example 1
 * ```
 */
export class DownloadClientPneumatic extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:DownloadClients/downloadClientPneumatic:DownloadClientPneumatic';
