 ...
 *
 * const example = new lidarr.notifications.NotificationProwl("example", {
 *     apiKey: "APIKey",
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Notifications/notificationProwl:NotificationProwl example 1
 * ```
 */
export class NotificationProwl extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Notifications/notificationProwl:NotificationProwl';
