 ...
 *
 * const example = new lidarr.notifications.NotificationPlex("example", {
 *     authToken: "AuthTOKEN",
 *     host: "plex.lcl",
 *     name: "Example",
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Notifications/notificationPlex:NotificationPlex example 1
 * ```
 */
export class NotificationPlex extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Notifications/notificationPlex:NotificationPlex';
