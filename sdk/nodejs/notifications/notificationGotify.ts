 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Notifications/notificationGotify:NotificationGotify example 1
 * ```
 */
export class NotificationGotify extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Notifications/notificationGotify:NotificationGotify';
