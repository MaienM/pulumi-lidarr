...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "lidarr:Metadata/metadata:Metadata":
                return new Metadata(name, <any>undefined, { urn })
            case "lidarr:Metadata/metadataConfig:MetadataConfig":
                return new MetadataConfig(name, <any>undefined, { urn })
            case "lidarr:Metadata/metadataKodi:MetadataKodi":
                return new MetadataKodi(name, <any>undefined, { urn })
            case "lidarr:Metadata/metadataRoksbox:MetadataRoksbox":
                return new MetadataRoksbox(name, <any>undefined, { urn })
            case "lidarr:Metadata/metadataWdtv:MetadataWdtv":
...
pulumi.runtime.registerResourceModule("lidarr", "Metadata/metadata", _module)
pulumi.runtime.registerResourceModule("lidarr", "Metadata/metadataConfig", _module)
pulumi.runtime.registerResourceModule("lidarr", "Metadata/metadataKodi", _module)
pulumi.runtime.registerResourceModule("lidarr", "Metadata/metadataRoksbox", _module)
pulumi.runtime.registerResourceModule("lidarr", "Metadata/metadataWdtv", _module)
