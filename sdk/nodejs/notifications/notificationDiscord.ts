 ...
 *
 * const example = new lidarr.notifications.NotificationDiscord("example", {
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Notifications/notificationDiscord:NotificationDiscord example 1
 * ```
 */
export class NotificationDiscord extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Notifications/notificationDiscord:NotificationDiscord';
