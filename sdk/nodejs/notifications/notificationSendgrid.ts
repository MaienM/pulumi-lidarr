 ...
 *
 * const example = new lidarr.notifications.NotificationSendgrid("example", {
 *     apiKey: "APIkey",
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Notifications/notificationSendgrid:NotificationSendgrid example 1
 * ```
 */
export class NotificationSendgrid extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Notifications/notificationSendgrid:NotificationSendgrid';
