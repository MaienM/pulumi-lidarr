 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Notifications/notificationEmail:NotificationEmail example 1
 * ```
 */
export class NotificationEmail extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Notifications/notificationEmail:NotificationEmail';
