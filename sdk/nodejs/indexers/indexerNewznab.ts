 ...
 *
 * const example = new lidarr.indexers.IndexerNewznab("example", {
 *     apiPath: "/api",
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Indexers/indexerNewznab:IndexerNewznab example 1
 * ```
 */
export class IndexerNewznab extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Indexers/indexerNewznab:IndexerNewznab';
