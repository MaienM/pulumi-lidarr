 ...
 *
 * const example = new lidarr.importlists.ImportListSpotifyPlaylists("example", {
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:ImportLists/importListSpotifyPlaylists:ImportListSpotifyPlaylists example 1
 * ```
 */
export class ImportListSpotifyPlaylists extends pulumi.CustomResource {
    /**
     * Get an existing ImportListSpotifyPlaylists resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ImportListSpotifyPlaylistsState, opts?: pulumi.CustomResourceOptions): ImportListSpotifyPlaylists {
        return new ImportListSpotifyPlaylists(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'lidarr:ImportLists/importListSpotifyPlaylists:ImportListSpotifyPlaylists';

    /**
     * Returns true if the given object is an instance of ImportListSpotifyPlaylists.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ImportListSpotifyPlaylists {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ImportListSpotifyPlaylists.__pulumiType;
    }
    ...
    /**
     * Create a ImportListSpotifyPlaylists resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ImportListSpotifyPlaylistsArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ImportListSpotifyPlaylistsArgs | ImportListSpotifyPlaylistsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ImportListSpotifyPlaylistsState | undefined;
            ...
            const args = argsOrState as ImportListSpotifyPlaylistsArgs | undefined;
            ...
            if ((!args || args.playlistIds === undefined) && !opts.urn) {
                throw new Error("Missing required property 'playlistIds'");
            }
        ...
        super(ImportListSpotifyPlaylists.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering ImportListSpotifyPlaylists resources.
 */
export interface ImportListSpotifyPlaylistsState {
    /**
     * Access token.
     */
...
/**
 * The set of arguments for constructing a ImportListSpotifyPlaylists resource.
 */
export interface ImportListSpotifyPlaylistsArgs {
    /**
     * Access token.
     */
    accessToken: pulumi.Input<string>;
