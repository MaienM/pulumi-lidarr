 ...
 *
 * const example = new lidarr.notifications.NotificationSignal("example", {
 *     authPassword: "Token",
 *     authUsername: "User",
 *     host: "localhost",
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Notifications/notificationSignal:NotificationSignal example 1
 * ```
 */
export class NotificationSignal extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Notifications/notificationSignal:NotificationSignal';
