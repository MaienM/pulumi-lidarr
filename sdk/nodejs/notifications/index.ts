...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "lidarr:Notifications/notification:Notification":
                return new Notification(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationApprise:NotificationApprise":
                return new NotificationApprise(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationBoxcar:NotificationBoxcar":
                return new NotificationBoxcar(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationCustomScript:NotificationCustomScript":
                return new NotificationCustomScript(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationDiscord:NotificationDiscord":
                return new NotificationDiscord(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationEmail:NotificationEmail":
                return new NotificationEmail(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationEmby:NotificationEmby":
                return new NotificationEmby(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationGotify:NotificationGotify":
                return new NotificationGotify(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationJoin:NotificationJoin":
                return new NotificationJoin(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationKodi:NotificationKodi":
                return new NotificationKodi(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationMailgun:NotificationMailgun":
                return new NotificationMailgun(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationNotifiarr:NotificationNotifiarr":
                return new NotificationNotifiarr(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationNtfy:NotificationNtfy":
                return new NotificationNtfy(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationPlex:NotificationPlex":
                return new NotificationPlex(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationProwl:NotificationProwl":
                return new NotificationProwl(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationPushbullet:NotificationPushbullet":
                return new NotificationPushbullet(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationPushover:NotificationPushover":
                return new NotificationPushover(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationSendgrid:NotificationSendgrid":
                return new NotificationSendgrid(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationSignal:NotificationSignal":
                return new NotificationSignal(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationSimplepush:NotificationSimplepush":
                return new NotificationSimplepush(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationSlack:NotificationSlack":
                return new NotificationSlack(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationSubsonic:NotificationSubsonic":
                return new NotificationSubsonic(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationSynologyIndexer:NotificationSynologyIndexer":
                return new NotificationSynologyIndexer(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationTelegram:NotificationTelegram":
                return new NotificationTelegram(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationTwitter:NotificationTwitter":
                return new NotificationTwitter(name, <any>undefined, { urn })
            case "lidarr:Notifications/notificationWebhook:NotificationWebhook":
...
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notification", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationApprise", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationBoxcar", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationCustomScript", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationDiscord", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationEmail", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationEmby", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationGotify", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationJoin", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationKodi", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationMailgun", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationNotifiarr", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationNtfy", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationPlex", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationProwl", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationPushbullet", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationPushover", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationSendgrid", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationSignal", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationSimplepush", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationSlack", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationSubsonic", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationSynologyIndexer", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationTelegram", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationTwitter", _module)
pulumi.runtime.registerResourceModule("lidarr", "Notifications/notificationWebhook", _module)
