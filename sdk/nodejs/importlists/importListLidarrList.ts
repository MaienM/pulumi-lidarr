 ...
 *
 * const example = new lidarr.importlists.ImportListLidarrList("example", {
 *     enableAutomaticAdd: false,
 *     listId: "itunes/album/new",
 *     metadataProfileId: 1,
 *     monitorNewItems: "all",
 *     name: "Example",
 *     qualityProfileId: 1,
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:ImportLists/importListLidarrList:ImportListLidarrList example 1
 * ```
 */
export class ImportListLidarrList extends pulumi.CustomResource {
    /**
     * Get an existing ImportListLidarrList resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ImportListLidarrListState, opts?: pulumi.CustomResourceOptions): ImportListLidarrList {
        return new ImportListLidarrList(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'lidarr:ImportLists/importListLidarrList:ImportListLidarrList';

    /**
     * Returns true if the given object is an instance of ImportListLidarrList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ImportListLidarrList {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ImportListLidarrList.__pulumiType;
    }
    ...
    /**
     * Create a ImportListLidarrList resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ImportListLidarrListArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ImportListLidarrListArgs | ImportListLidarrListState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ImportListLidarrListState | undefined;
            ...
            const args = argsOrState as ImportListLidarrListArgs | undefined;
        ...
        super(ImportListLidarrList.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * Input properties used for looking up and filtering ImportListLidarrList resources.
 */
export interface ImportListLidarrListState {
    /**
     * Enable automatic add flag.
     */
...
/**
 * The set of arguments for constructing a ImportListLidarrList resource.
 */
export interface ImportListLidarrListArgs {
    /**
     * Enable automatic add flag.
     */
    enableAutomaticAdd?: pulumi.Input<boolean>;
