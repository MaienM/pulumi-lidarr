 ...
 *
 * const example = new lidarr.metadata.MetadataWdtv("example", {
 *     enable: true,
 *     name: "Example",
 *     trackMetadata: true,
 * });
 ...
 *
 * ```sh
 *  $ pulumi import lidarr:Metadata/metadataWdtv:MetadataWdtv example 1
 * ```
 */
export class MetadataWdtv extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Metadata/metadataWdtv:MetadataWdtv';
