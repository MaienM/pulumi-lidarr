 ...
 *
 * const example = lidarr.DownloadClients.getDownloadClient({
 *     name: "Example",
 * });
 * ```
 */
export function getDownloadClient(args: GetDownloadClientArgs, opts?: pulumi.InvokeOptions): Promise<GetDownloadClientResult> {
    ...
    return pulumi.runtime.invoke("lidarr:DownloadClients/getDownloadClient:getDownloadClient", {
        "name": args.name,
    }, opts);
}
...
export interface GetDownloadClientResult {
     ...
     * Music category.
     */
    readonly musicCategory: string;
    /**
     * Music directory.
     */
    readonly musicDirectory: string;
    /**
     * Music imported category.
     */
    readonly musicImportedCategory: string;
    /**
     * Download Client name.
     */
     ...
     */
    readonly olderMusicPriority: number;
    /**
     * Password.
     */
     ...
     */
    readonly recentMusicPriority: number;
    /**
