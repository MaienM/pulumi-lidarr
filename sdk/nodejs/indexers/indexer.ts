 ...
 *
 * const example = new lidarr.indexers.Indexer("example", {
 *     apiPath: "/api",
...
export class Indexer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'lidarr:Indexers/indexer:Indexer';
     ...
     * RSS passkey.
     */
    public readonly rssPasskey!: pulumi.Output<string>;
    /**
     * Seed ratio.
     */
    ...
    constructor(name: string, argsOrState?: IndexerArgs | IndexerState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["rssPasskey"] = state ? state.rssPasskey : undefined;
            ...
            resourceInputs["rssPasskey"] = args ? args.rssPasskey : undefined;
...
export interface IndexerState {
     ...
     * RSS passkey.
     */
    rssPasskey?: pulumi.Input<string>;
    /**
     * Seed ratio.
     */
